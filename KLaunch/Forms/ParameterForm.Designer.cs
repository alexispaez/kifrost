namespace KLaunch
{
    partial class ParameterForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.checkBoxPatchFileType = new System.Windows.Forms.CheckBox();
			...
			this.buttonSave.Name = "buttonSaveRec";
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.checkBoxPatchFileType);
			...
			// 
			// checkBoxPatchFileTyppe
			// 
			// 
			// checkBoxPatchFileType
			// 
			this.checkBoxPatchFileType.AutoSize = true;
			this.checkBoxPatchFileType.Location = new System.Drawing.Point(13, 75);
			this.checkBoxPatchFileType.Name = "checkBoxPatchFileType";
			this.checkBoxPatchFileType.Size = new System.Drawing.Size(153, 17);
			this.checkBoxPatchFileType.TabIndex = 6;
			this.checkBoxPatchFileType.Text = "Patch info file format (XML)";
			this.checkBoxPatchFileType.UseVisualStyleBackColor = true;
			// this.checkBoxPatchFileType.CheckedChanged += new System.EventHandler(this.checkBoxPatchFileType_CheckedChanged);
			// 
			// buttonConnections
			// 
		...
		private System.Windows.Forms.CheckBox checkBoxPatchFileType;
	}
}